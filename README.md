...
What a team owns, who's accountable for what, how to ask it for things, how much it can take on — that's its API. Usually this information is scattered across wikis, onboarding docs, and people's heads, where it drifts out of date and can't be queried.
