...
| `teamapi serve-api <patterns...> [--port 3000] [--host <host>] [--token <token>] [--cors-origin <origin...>] [--rate-limit <n>] [--allow-anonymous] [--watch] [--reload-endpoint]` | Start the read-only REST API ([exposing it beyond localhost](#rest-api))                                                                                                                                                                 |
